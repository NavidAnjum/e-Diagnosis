...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Medicine') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                                ...
                                <form method="POST" action="{{ route('save_med') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="dose" type="text" class="form-control" name="dose" value="" required autofocus>
                                    </div>
                                </div>
