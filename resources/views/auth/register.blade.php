            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="address_line" class="col-md-4 col-form-label text-md-right">{{ __('Address Line') }}</label>

                            <div class="col-md-6">
                                <input id="address_line" type="text" class="form-control @error('address_line') is-invalid @enderror" name="address_line" value="{{ old('address_line') }}" required autocomplete="address_line" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="thana" type="text" class="form-control @error('thana') is-invalid @enderror" name="thana" value="{{ old('thana') }}" required autocomplete="thana" autofocus>
