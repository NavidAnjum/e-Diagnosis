        ...
        <tr>
            ...
            <td>
                ...
                <form id="cart_form{!! $text !!}" class="cart_form">
                    @csrf
                    <input type="hidden" id="name{!! $text !!}" name="name{!! $text !!}" value="{{$other->name}}">
                    <input type="hidden" id="price{!! $text !!}" name="price{!! $text !!}" value="{{$other->price}}">
                    <input type="hidden" id="type{!! $text !!}" name="type{!! $text !!}" value="{{$other->type}} ">
                    <input type="hidden" id="size{!! $text !!}" name="size{!! $text !!}" value="{{$other->size}}">
